...
station_yaw: float = -123.29
render_pushout: float = 165.96
external_berry: bool = False
height_ele: int = 2 
height_grind: int = 3
command_prefix: str = "%"
singleplayer: bool = False
server_number: str = 9013
crafting: bool = False
...
log_channel_gacha: int = 1372084695314993234
log_active_queue: int = 1372084748138319952
log_wait_queue: int = 1372084716869779526
discord_api_key: str = ""
